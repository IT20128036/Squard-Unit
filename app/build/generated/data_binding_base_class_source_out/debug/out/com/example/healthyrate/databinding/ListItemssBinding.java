...
public final class ListItemssBinding implements ViewBinding {
  @NonNull
  ...
  private ListItemssBinding(@NonNull LinearLayout rootView, @NonNull TextView textView10,
      @NonNull TextView textView11, @NonNull TextView textView12, @NonNull TextView textView4,
  ...
  @NonNull
  public static ListItemssBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListItemssBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_itemss, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListItemssBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemssBinding((LinearLayout) rootView, textView10, textView11, textView12,
